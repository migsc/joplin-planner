...
})(SettingItemSubType = exports.SettingItemSubType || (exports.SettingItemSubType = {}));
var SettingStorage;
...
})(SettingSectionSource = exports.SettingSectionSource || (exports.SettingSectionSource = {}));
...
})(SyncStartupOperation = exports.SyncStartupOperation || (exports.SyncStartupOperation = {}));
var Env;
(function (Env) {
...
class Setting extends BaseModel_1.default {
    ...
    static metadata() {
        ...
        const emptyDirWarning = (0, locale_1._)('Attention: If you change this location, make sure you copy all your content to it before syncing, otherwise all files will be removed! See the FAQ for more details: %s', 'https://joplinapp.org/faq/');
        ...
        this.metadata_ = {
            ...
            'sync.target': {
                ...
                description: (appType) => {
                    return appType !== 'cli' ? null : (0, locale_1._)('The target to synchronise to. Each sync target may have additional parameters which are named as `sync.NUM.NAME` (all documented below).');
                },
                options: () => {
            ...
            'sync.2.path': {
                ...
                show: (settings) => {
                    try {
                        return settings['sync.target'] === SyncTargetRegistry_1.default.nameToId('filesystem');
                    }
                    catch (error) {
                        return false;
                    }
            ...
            'sync.9.path': {
                ...
                section: 'sync',
                show: (settings) => {
                    return settings['sync.target'] === SyncTargetRegistry_1.default.nameToId('joplinServer');
                },
                public: true,
            ...
            'sync.10.username': {
                ...
                section: 'sync',
                show: (settings) => {
                    return settings['sync.target'] === SyncTargetRegistry_1.default.nameToId('joplinCloud');
                },
                public: true,
                label: () => (0, locale_1._)('Joplin Cloud email'),
                storage: SettingStorage.File,
            },
            'sync.10.password': {
                value: '',
                ...
                public: true,
                label: () => (0, locale_1._)('Joplin Cloud password'),
                secure: true,
            },
            ...
            'sync.maxConcurrentConnections': { value: 5, type: SettingItemType.Int, storage: SettingStorage.File, isGlobal: true, public: true, advanced: true, section: 'sync', label: () => (0, locale_1._)('Max concurrent connections'), minimum: 1, maximum: 20, step: 1 },
            ...
            showNoteCounts: { value: true, type: SettingItemType.Bool, storage: SettingStorage.File, isGlobal: true, public: false, advanced: true, appTypes: [AppType.Desktop, AppType.Cli], label: () => (0, locale_1._)('Show note counts') },
            ...
            uncompletedTodosOnTop: { value: true, type: SettingItemType.Bool, storage: SettingStorage.File, isGlobal: true, section: 'note', public: true, appTypes: [AppType.Cli], label: () => (0, locale_1._)('Uncompleted to-dos on top') },
            showCompletedTodos: { value: true, type: SettingItemType.Bool, storage: SettingStorage.File, isGlobal: true, section: 'note', public: true, appTypes: [AppType.Cli], label: () => (0, locale_1._)('Show completed to-dos') },
            ...
            'editor.autoMatchingBraces': {
                ...
                section: 'note',
                appTypes: [AppType.Desktop],
                label: () => (0, locale_1._)('Auto-pair braces, parenthesis, quotations, etc.'),
                storage: SettingStorage.File,
                isGlobal: true,
            },
            'notes.sortOrder.reverse': { value: true, type: SettingItemType.Bool, storage: SettingStorage.File, isGlobal: true, section: 'note', public: true, label: () => (0, locale_1._)('Reverse sort order'), appTypes: [AppType.Cli] },
            ...
            'folders.sortOrder.reverse': { value: false, type: SettingItemType.Bool, storage: SettingStorage.File, isGlobal: true, public: true, label: () => (0, locale_1._)('Reverse sort order'), appTypes: [AppType.Cli] },
            trackLocation: { value: true, type: SettingItemType.Bool, section: 'note', storage: SettingStorage.File, isGlobal: true, public: true, label: () => (0, locale_1._)('Save geo-location with notes') },
            ...
            'editor.mobile.spellcheckEnabled': {
                ...
                public: true,
                appTypes: [AppType.Mobile],
                show: (settings) => settings['editor.beta'],
                label: () => (0, locale_1._)('Enable spellcheck in the beta editor'),
                storage: SettingStorage.File,
                isGlobal: true,
            },
            ...
            'editor.mobile.removeSpaceBelowToolbar': {
                ...
                public: true,
                appTypes: [AppType.Mobile],
                show: (settings) => settings['editor.mobile.removeSpaceBelowToolbar'],
            ...
            // Deprecated
            'markdown.plugin.softbreaks': { storage: SettingStorage.File, isGlobal: true, value: false, type: SettingItemType.Bool, section: 'markdownPlugins', public: true, appTypes: [AppType.Mobile, AppType.Desktop], label: () => `${(0, locale_1._)('Enable soft breaks')}${wysiwygYes}` },
            'markdown.plugin.typographer': { storage: SettingStorage.File, isGlobal: true, value: false, type: SettingItemType.Bool, section: 'markdownPlugins', public: true, appTypes: [AppType.Mobile, AppType.Desktop], label: () => `${(0, locale_1._)('Enable typographer support')}${wysiwygYes}` },
            'markdown.plugin.linkify': { storage: SettingStorage.File, isGlobal: true, value: true, type: SettingItemType.Bool, section: 'markdownPlugins', public: true, appTypes: [AppType.Mobile, AppType.Desktop], label: () => `${(0, locale_1._)('Enable Linkify')}${wysiwygYes}` },
            'markdown.plugin.katex': { storage: SettingStorage.File, isGlobal: true, value: true, type: SettingItemType.Bool, section: 'markdownPlugins', public: true, appTypes: [AppType.Mobile, AppType.Desktop], label: () => `${(0, locale_1._)('Enable math expressions')}${wysiwygYes}` },
            'markdown.plugin.fountain': { storage: SettingStorage.File, isGlobal: true, value: false, type: SettingItemType.Bool, section: 'markdownPlugins', public: true, appTypes: [AppType.Mobile, AppType.Desktop], label: () => `${(0, locale_1._)('Enable Fountain syntax support')}${wysiwygYes}` },
            'markdown.plugin.mermaid': { storage: SettingStorage.File, isGlobal: true, value: true, type: SettingItemType.Bool, section: 'markdownPlugins', public: true, appTypes: [AppType.Mobile, AppType.Desktop], label: () => `${(0, locale_1._)('Enable Mermaid diagrams support')}${wysiwygYes}` },
            'markdown.plugin.audioPlayer': { storage: SettingStorage.File, isGlobal: true, value: true, type: SettingItemType.Bool, section: 'markdownPlugins', public: true, appTypes: [AppType.Mobile, AppType.Desktop], label: () => `${(0, locale_1._)('Enable audio player')}${wysiwygNo}` },
            'markdown.plugin.videoPlayer': { storage: SettingStorage.File, isGlobal: true, value: true, type: SettingItemType.Bool, section: 'markdownPlugins', public: true, appTypes: [AppType.Mobile, AppType.Desktop], label: () => `${(0, locale_1._)('Enable video player')}${wysiwygNo}` },
            'markdown.plugin.pdfViewer': { storage: SettingStorage.File, isGlobal: true, value: !mobilePlatform, type: SettingItemType.Bool, section: 'markdownPlugins', public: true, appTypes: [AppType.Desktop], label: () => `${(0, locale_1._)('Enable PDF viewer')}${wysiwygNo}` },
            'markdown.plugin.mark': { storage: SettingStorage.File, isGlobal: true, value: true, type: SettingItemType.Bool, section: 'markdownPlugins', public: true, appTypes: [AppType.Mobile, AppType.Desktop], label: () => `${(0, locale_1._)('Enable ==mark== syntax')}${wysiwygYes}` },
            'markdown.plugin.footnote': { storage: SettingStorage.File, isGlobal: true, value: true, type: SettingItemType.Bool, section: 'markdownPlugins', public: true, appTypes: [AppType.Mobile, AppType.Desktop], label: () => `${(0, locale_1._)('Enable footnotes')}${wysiwygNo}` },
            'markdown.plugin.toc': { storage: SettingStorage.File, isGlobal: true, value: true, type: SettingItemType.Bool, section: 'markdownPlugins', public: true, appTypes: [AppType.Mobile, AppType.Desktop], label: () => `${(0, locale_1._)('Enable table of contents extension')}${wysiwygNo}` },
            'markdown.plugin.sub': { storage: SettingStorage.File, isGlobal: true, value: false, type: SettingItemType.Bool, section: 'markdownPlugins', public: true, appTypes: [AppType.Mobile, AppType.Desktop], label: () => `${(0, locale_1._)('Enable ~sub~ syntax')}${wysiwygYes}` },
            'markdown.plugin.sup': { storage: SettingStorage.File, isGlobal: true, value: false, type: SettingItemType.Bool, section: 'markdownPlugins', public: true, appTypes: [AppType.Mobile, AppType.Desktop], label: () => `${(0, locale_1._)('Enable ^sup^ syntax')}${wysiwygYes}` },
            'markdown.plugin.deflist': { storage: SettingStorage.File, isGlobal: true, value: false, type: SettingItemType.Bool, section: 'markdownPlugins', public: true, appTypes: [AppType.Mobile, AppType.Desktop], label: () => `${(0, locale_1._)('Enable deflist syntax')}${wysiwygNo}` },
            'markdown.plugin.abbr': { storage: SettingStorage.File, isGlobal: true, value: false, type: SettingItemType.Bool, section: 'markdownPlugins', public: true, appTypes: [AppType.Mobile, AppType.Desktop], label: () => `${(0, locale_1._)('Enable abbreviation syntax')}${wysiwygNo}` },
            'markdown.plugin.emoji': { storage: SettingStorage.File, isGlobal: true, value: false, type: SettingItemType.Bool, section: 'markdownPlugins', public: true, appTypes: [AppType.Mobile, AppType.Desktop], label: () => `${(0, locale_1._)('Enable markdown emoji')}${wysiwygNo}` },
            'markdown.plugin.insert': { storage: SettingStorage.File, isGlobal: true, value: false, type: SettingItemType.Bool, section: 'markdownPlugins', public: true, appTypes: [AppType.Mobile, AppType.Desktop], label: () => `${(0, locale_1._)('Enable ++insert++ syntax')}${wysiwygYes}` },
            'markdown.plugin.multitable': { storage: SettingStorage.File, isGlobal: true, value: false, type: SettingItemType.Bool, section: 'markdownPlugins', public: true, appTypes: [AppType.Mobile, AppType.Desktop], label: () => `${(0, locale_1._)('Enable multimarkdown table extension')}${wysiwygNo}` },
            ...
            showTrayIcon: {
                ...
                description: () => {
                    return platform === 'linux' ? (0, locale_1._)('Note: Does not work in all desktop environments.') : (0, locale_1._)('This will allow Joplin to run in the background. It is recommended to enable this setting so that your notes are constantly being synchronised, thus reducing the number of conflicts.');
                },
                storage: SettingStorage.File,
                isGlobal: true,
            },
            startMinimized: { value: false, type: SettingItemType.Bool, storage: SettingStorage.File, isGlobal: true, section: 'application', public: true, appTypes: [AppType.Desktop], label: () => (0, locale_1._)('Start application minimised in the tray icon') },
            ...
            'style.editor.fontSize': { value: 15, type: SettingItemType.Int, public: true, storage: SettingStorage.File, isGlobal: true, appTypes: [AppType.Desktop], section: 'appearance', label: () => (0, locale_1._)('Editor font size'), minimum: 4, maximum: 50, step: 1 },
            ...
            'style.editor.contentMaxWidth': { value: 0, type: SettingItemType.Int, public: true, storage: SettingStorage.File, isGlobal: true, appTypes: [AppType.Desktop], section: 'appearance', label: () => (0, locale_1._)('Editor maximum width'), description: () => (0, locale_1._)('Set it to 0 to make it take the complete available space. Recommended width is 600.') },
            ...
            'style.customCss.renderedMarkdown': {
                value: null,
                onClick: () => {
                    shim_1.default.openOrCreateFile(this.customCssFilePath(Setting.customCssFilenames.RENDERED_MARKDOWN), '/* For styling the rendered Markdown */');
                },
                type: SettingItemType.Button,
                public: true,
                appTypes: [AppType.Desktop],
            ...
            'style.customCss.joplinApp': {
                value: null,
                onClick: () => {
                    shim_1.default.openOrCreateFile(this.customCssFilePath(Setting.customCssFilenames.JOPLIN_APP), `/* For styling the entire Joplin app (except the rendered Markdown, which is defined in \`${Setting.customCssFilenames.RENDERED_MARKDOWN}\`) */`);
                },
                type: SettingItemType.Button,
                public: true,
                appTypes: [AppType.Desktop],
            ...
            autoUpdateEnabled: { value: true, type: SettingItemType.Bool, storage: SettingStorage.File, isGlobal: true, section: 'application', public: platform !== 'linux', appTypes: [AppType.Desktop], label: () => (0, locale_1._)('Automatically check for updates') },
            'autoUpdate.includePreReleases': { value: false, type: SettingItemType.Bool, section: 'application', storage: SettingStorage.File, isGlobal: true, public: true, appTypes: [AppType.Desktop], label: () => (0, locale_1._)('Get pre-releases when checking for updates'), description: () => (0, locale_1._)('See the pre-release page for more details: %s', 'https://joplinapp.org/prereleases') },
            ...
            'sync.interval': {
                ...
                options: () => {
                    return {
                        ...
                        300: (0, locale_1._)('%d minutes', 5),
                        600: (0, locale_1._)('%d minutes', 10),
                        1800: (0, locale_1._)('%d minutes', 30),
                        3600: (0, locale_1._)('%d hour', 1),
                        43200: (0, locale_1._)('%d hours', 12),
                        86400: (0, locale_1._)('%d hours', 24),
                    };
                },
                storage: SettingStorage.File,
                isGlobal: true,
            ...
            editor: { value: '', type: SettingItemType.String, subType: 'file_path_and_args', storage: SettingStorage.File, isGlobal: true, public: true, appTypes: [AppType.Cli, AppType.Desktop], label: () => (0, locale_1._)('Text editor command'), description: () => (0, locale_1._)('The editor command (may include arguments) that will be used to open a note. If none is provided it will try to auto-detect the default editor.') },
            'export.pdfPageSize': { value: 'A4', type: SettingItemType.String, advanced: true, storage: SettingStorage.File, isGlobal: true, isEnum: true, public: true, appTypes: [AppType.Desktop], label: () => (0, locale_1._)('Page size for PDF export'), options: () => {
                    return {
                        'A4': (0, locale_1._)('A4'),
            ...
            'export.pdfPageOrientation': { value: 'portrait', type: SettingItemType.String, storage: SettingStorage.File, isGlobal: true, advanced: true, isEnum: true, public: true, appTypes: [AppType.Desktop], label: () => (0, locale_1._)('Page orientation for PDF export'), options: () => {
                    return {
            ...
            'net.proxyEnabled': {
                ...
                isGlobal: true,
                public: true,
                label: () => (0, locale_1._)('Proxy enabled (beta)'),
                storage: SettingStorage.File,
            },
            'net.proxyUrl': {
                value: '',
                ...
                isGlobal: true,
                public: true,
                label: () => (0, locale_1._)('Proxy URL (beta)'),
                description: () => (0, locale_1._)('e.g "http://my.proxy.com:80". You can also set via environment variables'),
                storage: SettingStorage.File,
            },
            'net.proxyTimeout': {
                value: 1,
                ...
                isGlobal: true,
                public: true,
                label: () => (0, locale_1._)('proxy timeout (seconds) (beta)'),
                storage: SettingStorage.File,
            },
            ...
            'api.port': { value: null, type: SettingItemType.Int, storage: SettingStorage.File, isGlobal: true, public: true, appTypes: [AppType.Cli], description: () => (0, locale_1._)('Specify the port that should be used by the API server. If not set, a default will be used.') },
            ...
            'revisionService.enabled': { section: 'revisionService', storage: SettingStorage.File, value: true, type: SettingItemType.Bool, public: true, label: () => (0, locale_1._)('Enable note history') },
            'revisionService.ttlDays': {
                ...
                unitLabel: (value = null) => {
                    return value === null ? (0, locale_1._)('days') : (0, locale_1._)('%d days', value);
                },
        ...
        if (this.constants_.env === Env.Dev)
            this.validateMetadata(this.metadata_);
        return this.metadata_;
    }
    static validateMetadata(md) {
        for (const [k, v] of Object.entries(md)) {
            if (v.isGlobal && v.storage !== SettingStorage.File)
    ...
    static applyUserSettingMigration() {
    ...
    static registerSetting(key, metadataItem) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const valueRow = yield this.loadOne(key);
            if (valueRow) {
                this.cache_.push({
                    key: key,
    ...
    static registerSection(name, source, section) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    static loadOne(key) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.keyStorage(key) === SettingStorage.File) {
                let fileSettings = yield this.fileHandler.load();
                const md = this.settingMetadata(key);
                if (md.isGlobal) {
                    const rootFileSettings = yield this.rootFileHandler.load();
            ...
            const row = yield this.modelSelectOne('SELECT * FROM settings WHERE key = ?', [key]);
            if (row)
                return row;
            if (this.settingMetadata(key).secure) {
                return {
                    key,
                    value: yield this.keychainService().password(`setting.${key}`),
                };
            }
            return null;
        });
    ...
    static load() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.cache_ = [];
            const rows = yield this.modelSelectAll('SELECT * FROM settings');
            this.cache_ = [];
            ...
            for (const key of secureKeys) {
                if (rowKeys.includes(key))
                    continue;
                const password = yield this.keychainService().password(`setting.${key}`);
                if (password) {
                    secureItems.push({
                        key: key,
                        value: password,
    ...
    static canUseFileStorage() {
        return !shim_1.default.mobilePlatform();
    }
    static keyStorage(key) {
        if (!this.canUseFileStorage())
            return SettingStorage.Database;
        const md = this.settingMetadata(key);
    ...
    static deleteKeychainPasswords() {
        return __awaiter(this, void 0, void 0, function* () {
            const secureKeys = this.keys(false, null, { secureOnly: true });
            for (const key of secureKeys) {
                yield this.keychainService().deletePassword(`setting.${key}`);
            }
        });
    }
    static enumOptionsToValueLabels(enumOptions, order, options = null) {
        ...
        for (const k in enumOptions) {
            if (!enumOptions.hasOwnProperty(k))
                continue;
            if (order.includes(k))
                continue;
            output.push({
    ...
    static saveAll() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < this.cache_.length; i++) {
                ...
                if (this.isSecureKey(s.key)) {
                    ...
                    try {
                        ...
                        const currentValue = yield this.keychainService().password(passwordName);
                        if (currentValue !== valueAsString) {
                            const wasSet = yield this.keychainService().setPassword(passwordName, valueAsString);
                            if (wasSet)
                                continue;
                        }
                        else {
            ...
            yield BaseModel_1.default.db().transactionExecBatch(queries);
            if (this.canUseFileStorage()) {
                if (this.value('isSubProfile')) {
                    const { globalSettings, localSettings } = (0, splitGlobalAndLocalSettings_1.default)(valuesForFile);
                    const currentGlobalSettings = yield this.rootFileHandler.load();
                    ...
                    yield this.rootFileHandler.save(Object.assign(Object.assign({}, currentGlobalSettings), globalSettings));
                    yield this.fileHandler.save(localSettings);
                }
                else {
                    yield this.fileHandler.save(valuesForFile);
                }
            }
    ...
    static emitScheduledChangeEvent() {
        ...
        this.changedKeys_ = [];
        eventManager_1.default.emit('settingsChange', { keys });
    }
    static scheduleSave() {
        ...
        if (this.saveTimeoutId_)
            shim_1.default.clearTimeout(this.saveTimeoutId_);
        this.saveTimeoutId_ = shim_1.default.setTimeout(() => __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.saveAll();
            }
            catch (error) {
    ...
    static typeToString(typeId) {
        if (typeId === SettingItemType.Int)
            return 'int';
        if (typeId === SettingItemType.String)
            return 'string';
        if (typeId === SettingItemType.Bool)
            return 'bool';
        if (typeId === SettingItemType.Array)
            return 'array';
        if (typeId === SettingItemType.Object)
            return 'object';
        throw new Error(`Invalid type ID: ${typeId}`);
    }
    static sectionSource(sectionName) {
        if (this.customSections_[sectionName])
            return this.customSections_[sectionName].source || SettingSectionSource.Default;
    ...
    static sectionDescription(name) {
        ...
        if (name === 'general')
            return (0, locale_1._)('Notes and settings are stored in: %s', toSystemSlashes(this.value('profileDir'), process.platform));
    ...
    static sectionNameToIcon(name) {
        ...
        if (name === 'revisionService')
            return 'icon-note-history';
        if (name === 'encryption')
            return 'icon-encryption';
        if (name === 'server')
