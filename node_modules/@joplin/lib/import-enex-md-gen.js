...
exports.addResourceTag = exports.NEWLINE = exports.processMdArrayNewLines = exports.enexXmlToMd = void 0;
...
exports.addResourceTag = addResourceTag;
        ...
        saxStream.on('opentag', function (node) {
            ...
            if (n === 'en-note') {
                ...
                if (nodeAttributes.src) {
                    ...
                    let s = '![';
                    if (nodeAttributes.alt)
                        s += tagAttributeToMdText(nodeAttributes.alt);
                    s += `](${markdownUtils_1.default.escapeLinkUrl(nodeAttributes.src)})`;
                    section.lines.push(s);
                }
            }
            else if (isAnchor(n)) {
...
function enexXmlToMd(xmlString, resources) {
    return __awaiter(this, void 0, void 0, function* () {
        const stream = stringToStream(xmlString);
        const result = yield enexXmlToMdArray(stream, resources);
...
//# sourceMappingURL=import-enex-md-gen.js.map