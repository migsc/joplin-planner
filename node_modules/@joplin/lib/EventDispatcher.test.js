...
var TestKey;
(function (TestKey) {
    TestKey[TestKey["FooEvent"] = 0] = "FooEvent";
    TestKey[TestKey["BarEvent"] = 1] = "BarEvent";
    TestKey[TestKey["BazEvent"] = 2] = "BazEvent";
})(TestKey || (TestKey = {}));
describe('EventDispatcher', () => {
    it('should trigger after adding a listener', () => {
        const dispatcher = new EventDispatcher_1.default();
        let calledCount = 0;
