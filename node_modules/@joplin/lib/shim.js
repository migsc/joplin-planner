...
const shim = {
    ...
    fetchWithRetry: function (fetchFn, options = null) {
                ...
                try {
                    ...
                    if (shim.fetchRequestCanBeRetried(error)) {
                        ...
                        if (retryCount > options.maxRetry)
                            throw error;
                        yield shim.msleep_(retryCount * 3000);
                    }
                    else {
                        throw error;
                    }
    ...
    fetchText: (url, options = null) => __awaiter(void 0, void 0, void 0, function* () {
        const r = yield shim.fetch(url, options || {});
        if (!r.ok)
            throw new Error(`Could not fetch ${url}`);
        return r.text();
    }),
    createResourceFromPath: (_filePath, _defaultProps = null, _options = null) => __awaiter(void 0, void 0, void 0, function* () {
        throw new Error('Not implemented');
    }),
    ...
    sjclModule: null,
    randomBytes: (_count) => __awaiter(void 0, void 0, void 0, function* () {
        throw new Error('Not implemented');
    }),
    stringByteLength: (_s) => {
        throw new Error('Not implemented');
    ...
    attachFileToNote: (_note, _filePath) => __awaiter(void 0, void 0, void 0, function* () {
        throw new Error('Not implemented');
    }),
    attachFileToNoteBody: (_body, _filePath, _position, _options) => __awaiter(void 0, void 0, void 0, function* () {
        throw new Error('Not implemented');
    }),
    imageToDataUrl: (_filePath, _maxSize = 0) => __awaiter(void 0, void 0, void 0, function* () {
        throw new Error('Not implemented');
    }),
    imageFromDataUrl: (_imageDataUrl, _filePath, _options = null) => __awaiter(void 0, void 0, void 0, function* () {
        throw new Error('Not implemented');
    }),
