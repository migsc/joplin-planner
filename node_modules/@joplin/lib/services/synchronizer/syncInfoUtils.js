...
exports.masterKeyById = exports.setPpk = exports.addMasterKey = exports.masterKeyEnabled = exports.setMasterKeyHasBeenUsed = exports.setMasterKeyEnabled = exports.getActiveMasterKey = exports.setActiveMasterKeyId = exports.getActiveMasterKeyId = exports.setEncryptionEnabled = exports.getEncryptionEnabled = exports.SyncInfo = exports.syncInfoEquals = exports.mergeSyncInfos = exports.localSyncInfoFromState = exports.localSyncInfo = exports.saveLocalSyncInfo = exports.fetchSyncInfo = exports.uploadSyncInfo = exports.migrateLocalSyncInfo = void 0;
const Setting_1 = require("../../models/Setting");
const fastDeepEqual = require('fast-deep-equal');
function migrateLocalSyncInfo(db) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const masterKeys = yield db.selectAll('SELECT * FROM master_keys');
        const masterKeyMap = {};
        ...
        yield saveLocalSyncInfo(syncInfo);
    });
}
exports.migrateLocalSyncInfo = migrateLocalSyncInfo;
function uploadSyncInfo(api, syncInfo) {
    return __awaiter(this, void 0, void 0, function* () {
        yield api.put('info.json', syncInfo.serialize());
    });
}
exports.uploadSyncInfo = uploadSyncInfo;
function fetchSyncInfo(api) {
    return __awaiter(this, void 0, void 0, function* () {
        const syncTargetInfoText = yield api.get('info.json');
        ...
        if (syncTargetInfoText) {
            ...
            const oldVersion = yield api.get('.sync/version.txt');
            if (oldVersion)
                output = { version: 1 };
        }
...
function localSyncInfo() {
    return new SyncInfo(Setting_1.default.value('syncInfoCache'));
}
...
//# sourceMappingURL=syncInfoUtils.js.map