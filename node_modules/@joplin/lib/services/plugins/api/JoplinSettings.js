...
class JoplinSettings {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            for (const [key, setting] of Object.entries(settings)) {
                ...
                if ('section' in setting)
                    internalSettingItem.section = this.namespacedKey(setting.section);
                ...
                yield Setting_1.default.registerSetting(this.namespacedKey(key), internalSettingItem);
            }
        });
    }
    /**
     ...
     */
    registerSetting(key, settingItem) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.registerSettings({ [key]: settingItem });
        });
    }
    /**
    ...
    registerSection(name, section) {
        return __awaiter(this, void 0, void 0, function* () {
            return Setting_1.default.registerSection(this.namespacedKey(name), Setting_1.SettingSectionSource.Plugin, section);
        });
    }
    /**
    ...
    value(key) {
        return __awaiter(this, void 0, void 0, function* () {
            return Setting_1.default.value(this.namespacedKey(key));
        });
    }
    /**
    ...
    setValue(key, value) {
        return __awaiter(this, void 0, void 0, function* () {
            return Setting_1.default.setValue(this.namespacedKey(key), value);
        });
    }
    /**
    ...
    onChange(handler) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            eventManager_1.default.on('settingsChange', (event) => {
...
//# sourceMappingURL=JoplinSettings.js.map