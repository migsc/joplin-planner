...
class SearchEngine {
    ...
    rebuildIndex_() {
        return __awaiter(this, void 0, void 0, function* () {
            let noteIds = yield this.db().selectAll('SELECT id FROM notes WHERE is_conflict = 0 AND encryption_applied = 0');
    ...
    search(searchString, options = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (searchType === SearchEngine.SEARCH_TYPE_BASIC) {
                ...
                const rows = yield this.basicSearch(searchString);
                ...
                try {
                    ...
                    const rows = yield this.db().selectAll(query, params);
...
SearchEngine.SEARCH_TYPE_NONLATIN_SCRIPT = 'nonlatin';
