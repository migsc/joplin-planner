...
function default_1(href, options = null) {
    var _a, _b, _c;
    options = Object.assign({ title: '', resources: {}, ResourceModel: null, linkRenderingType: 1, plainResourceRendering: false, postMessageSyntax: 'postMessage', enableLongPress: false }, options);
    ...
    if (isResourceUrl) {
        ...
        const resourceStatus = utils_1.default.resourceStatus(options.ResourceModel, result);
        ...
        if (result && resourceStatus !== 'ready' && !options.plainResourceRendering) {
            const icon = utils_1.default.resourceStatusFile(resourceStatus);
            return {
                resourceReady: false,
    ...
    if (options.enableLongPress && !!resourceId) {
        ...
        js = (0, createEventHandlingAttrs_1.default)(resourceId, {
            enableLongPress: (_a = options.enableLongPress) !== null && _a !== void 0 ? _a : false,
            postMessageSyntax: (_b = options.postMessageSyntax) !== null && _b !== void 0 ? _b : 'void',
    ...
    let resourceFullPath = resource && ((_c = options === null || options === void 0 ? void 0 : options.ResourceModel) === null || _c === void 0 ? void 0 : _c.fullPath) ? options.ResourceModel.fullPath(resource) : null;
